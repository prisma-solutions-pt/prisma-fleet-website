...
const CARDS = [
  {
    ...
    desc: "Importa os ganhos, aplica renda, combustível, Via Verde e deduções. O cálculo é instantâneo. Renda fixa ou revenue share.",
    screenshot: "settlements",
  },
  {
    title: "Importação inteligente",
    desc: "Arrasta ficheiros CSV ou XLSX. O parser reconhece as colunas automaticamente e mapeia tudo ao motorista certo.",
    screenshot: "imports",
  },
  {
...
const EXTRA_FEATURES = [
  {
    ...
    desc: "Gera ficheiros SEPA XML prontos para o banco.",
  },
  {
  ...
  },
  {
    ...
    title: "Multi-empresa.",
    desc: "Gere até 5 empresas com uma só conta.",
  },
  {
    ...
    title: "CRM integrado.",
    desc: "Gere leads e acompanha potenciais motoristas.",
  },
  {
    ...
    title: "Manutenção.",
    desc: "Regista revisões, seguros e inspeções.",
  },
  {
